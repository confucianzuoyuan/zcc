...
func hasBuiltinMacro(start *Token) *Token {
	...
	hasIt := tok.isEqual("__builtin_alloca") || tok.isEqual("__builtin_offsetof") || tok.isEqual("__builtin_types_compatible_p") || tok.isEqual("__builtin_va_start") || tok.isEqual("__builtin_va_copy") || tok.isEqual("__builtin_va_end") || tok.isEqual("__builtin_va_arg") || tok.isEqual("__builtin_constant_p")
